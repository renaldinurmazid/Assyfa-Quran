...
class MosqueCharityPaymentDetailScreen extends StatelessWidget {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // 2. Adaptive: QRIS or Bank Transfer
                  if (payment.isQris)
  ...
  Widget _buildQrisPaymentInfo(BuildContext context, MosquePayment payment) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
  ...
  /// Bank Transfer / VA Payment Info
  Widget _buildBankTransferPaymentInfo(BuildContext context, MosquePayment payment) {
  ...
  Widget _buildPaymentMethod(BuildContext context, MosquePayment payment) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: context.theme.colorScheme.surface,
