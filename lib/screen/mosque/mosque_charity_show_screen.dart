...
class MosqueCharityShowScreen extends StatelessWidget {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildPriceContainer(context, mosque),
                            const SizedBox(height: 16),
  ...
  Widget _buildPriceContainer(BuildContext context, MosqueCharityData mosque) {
    return Container(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  'dari target ${mosque.targetAmount ?? 'Tanpa Target'}',
  ...
  Widget _buildProgressSection(BuildContext context, MosqueCharityData mosque) {
    final double progress = (mosque.percentage / 100).clamp(0.0, 1.0);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
        ...
        children: [
          Row(
            children: [
              ...
              Text("Tentang Masjid", style: pBold14),
            ],
          ),
          const SizedBox(height: 16),
          HtmlWidget(
